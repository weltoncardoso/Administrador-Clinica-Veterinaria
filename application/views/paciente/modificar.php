<div class="modal-header modal-header-personalizado">
    ...
    <span class="modal-title">Modificar Paciente</span>
</div>
<div class="modal-body">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12">
                <form id="frmPacienteModificar" name="frmPacienteModificar">            
                    <div class="row">                    
                        <div class="col-sm-12">
                            <div id="pacientes">
                                <div class="panel panel-<?php echo COLOR ?>" id="pacientes_template">
                                    <div class="panel-body">
                                        ...
                                        <div class="row">
                                            <input id="inIdPaciente#index#" name="inPaciente[#index#][id]" type="hidden" value="<?php echo $paciente[ID_PACIENTE] ?>">
                                            <div class="col-lg-4 form-group form-group-sm">
                                                ...
                                                <input class="form-control" id="inNombrePaciente#index#" name="inPaciente[#index#][nombre]" type="text" value="<?php echo $paciente[NOMBRE_PACIENTE] ?>">
                                            </div>
                                            <div class="col-lg-4 form-group form-group-sm">
                                                ...
                                                <select class="form-control" id="inEspeciePaciente#index#" name="inPaciente[#index#][especie]">
                                                    ...
                                                    <option value="CANINO" <?php echo $paciente[ESPECIE_PACIENTE] == 'CANINO' ? 'selected' : '' ?>>CANINO</option>
                                                    <option value="FELINO" <?php echo $paciente[ESPECIE_PACIENTE] == 'FELINO' ? 'selected' : '' ?>>FELINO</option>                                                        
                                                    <option value="OTRO" <?php echo $paciente[ESPECIE_PACIENTE] == 'OTRO' ? 'selected' : '' ?>>OTRO</option>
                                                </select>
                                            </div>
                                            <div class="col-lg-4 form-group form-group-sm">
                                                ...
                                                <input class="form-control" id="inRazaPaciente#index#" name="inPaciente[#index#][raza]" type="text" value="<?php echo $paciente[RAZA_PACIENTE] ?>">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-4 form-group form-group-sm">
                                                ...
                                                <select class="form-control" id="inSexoPaciente#index#" name="inPaciente[#index#][sexo]">
                                                    <option value="">SELECCIONAR</option>
                                                    <option value="HEMBRA" <?php echo $paciente[SEXO_PACIENTE] == 'HEMBRA' ? 'selected' : '' ?>>HEMBRA</option>
                                                    <option value="MACHO" <?php echo $paciente[SEXO_PACIENTE] == 'MACHO' ? 'selected' : '' ?>>MACHO</option>
                                                </select>
                                            </div>
                                            <div class="col-lg-4 form-group form-group-sm">
                                                ...
                                                <div class="input-group">
                                                    <input class="form-control fecha" id="inFechaNacimientoPaciente#index#" name="inPaciente[#index#][fechanacimiento]" onclick="event.stopPropagation(); return false;" readonly type="text" value="<?php echo $paciente[FECHA_NACIMIENTO_PACIENTE] ?>">
                                            ...
                                            <div class="col-lg-4 form-group form-group-sm">
                                                ...
                                                <input class="form-control" id="inChipPaciente#index#" name="inPaciente[#index#][chip]" type="text" value="<?php echo $paciente[CHIP_PACIENTE] ?>">
                                            </div>
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12 form-group form-group-sm">
                                                ...
                                                <textarea class="form-control" id="inDescripcionPaciente#index#" name="inPaciente[#index#][descripcion]" rows="5"><?php echo $paciente[DESCRIPCION_PACIENTE] ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12" id="pacientes_controls">
...
<div class="modal-footer">
    <button type="button" class="btn btn-<?php echo COLOR ?>" onclick="procesarFormularioModal('<?php echo base_url('Paciente/Modificar') ?>', 'frmPacienteModificar', 'El paciente ha sido modificado.', 'Error en la modificación del paciente, por favor comuníquese con el administrador del sistema.', null, true, '#modal')">Guardar</button>
